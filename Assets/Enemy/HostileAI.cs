...
public class HostileAI : MonoBehaviour
{
    ...
    [SerializeField] private float canShoot = 1f;
    ...
    {
        if (projectilePrefab == null || firePoint == null || canShoot == 0f) return;
        ...
        projectileRb.AddForce(transform.up * verticalShotForce, ForceMode.Impluse);
    ...
    private void FindPatrolPoint()
    {
        ...
        float random2 = Random.Range(-patrolRadius, patrolRadius);

        Vector3 potentialPoint = new Vector3(transform.position.x + randomX, transform.position.y, transform.position.z + ramdomZ);
    ...
    private void UpdateBehaviourState()
    {
        ...
        else if (isPlayerVisible && isPlayerInRange && canShoot == 1f)
        {
            PerformAttack();
        }
    }
